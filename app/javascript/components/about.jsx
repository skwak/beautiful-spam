  ...
  return (
    <div className="about">
      ...
      <p className="about--text">
        ...
        myself. This is the spam I'd get, after deeply hoping and almost giving up,
        but then getting them. In this universe, I get everything I want, but only after a little struggle
